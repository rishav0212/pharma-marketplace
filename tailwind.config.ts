...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'primary-glow': '0 0 20px -5px rgba(2, 132, 199, 0.4)',
        'accent-glow': '0 0 20px -5px rgba(6, 182, 212, 0.4)',
      ...
      backgroundImage: {
        ...
        'gradient-hero': 'linear-gradient(135deg, #0c4a6e 0%, #075985 25%, #0891b2 75%, #06b6d4 100%)',
        'gradient-primary': 'linear-gradient(135deg, #0284c7 0%, #0891b2 50%, #06b6d4 100%)',
