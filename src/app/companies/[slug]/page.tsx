          ...
          <div className="lg:col-span-2 space-y-8 mt-4 lg:mt-0">
              ...
              <section className="bg-white rounded-2xl shadow-sm border border-neutral-200 p-6">
                ...
                <div className="flex flex-wrap gap-3">
                  {company.certifications.map((cert, index) => (
                    <div
                      key={index}
                      className="flex items-center gap-2 px-4 py-3 bg-neutral-50 border border-neutral-100 rounded-lg"
                    >
            ...
            <section>
              <div className="flex items-center justify-between mb-6">
                ...
                <Link
                  href="/products"
                  className="text-primary-600 font-medium hover:text-primary-700 flex items-center gap-1 text-sm"
                >
